...
query = """
    ...
    WHERE sr.payment_status = 'Pending' AND sr.shop_id = %s AND sr.status = 'Approved'
...
<body>
    ...
    <div class="table-wrapper">
        <h3 class="mb-4 text-primary"><i class="bi bi-wallet2 me-2"></i>Pending Payments</h3>
""")
...
if data:
    ...
    print("""
        <div class="alert alert-info text-center">
            <i class="bi bi-info-circle"></i> No pending payments found.
        </div>
    """)
